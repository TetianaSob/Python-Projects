...
# File "d:/MY STUFF/Online courses/Python/FirstProgram/Http_requests_Headers2.py", line 12, in <module>
#     print(response.json()) # <bound method Response.json of <Response [200]>>
# File "C:\Users\Tetiana\AppData\Local\Programs\Python\Python38-32\lib\site-packages\requests\models.py", line 898, in json 
#     return complexjson.loads(self.text, **kwargs)
# File "C:\Users\Tetiana\AppData\Local\Programs\Python\Python38-32\lib\json\__init__.py", line 357, in loads
#     return _default_decoder.decode(s)
# File "C:\Users\Tetiana\AppData\Local\Programs\Python\Python38-32\lib\json\decoder.py", line 337, in decode
#     obj, end = self.raw_decode(s, idx=_w(s, 0).end())
# File "C:\Users\Tetiana\AppData\Local\Programs\Python\Python38-32\lib\json\decoder.py", line 355, in raw_decode
...
<meta property="og:url" content="https://icanhazdadjoke.com/j/ea2wkyscah" />
<meta property="og:description" content="What does an angry pepper do? It gets jalapeño face." />
<meta property="og:image:url" content="https://icanhazdadjoke.com/j/ea2wkyscah.png" />
<meta property="og:image:secure_url" content="https://icanhazdadjoke.com/j/ea2wkyscah.png" />
...
<meta name="twitter:description" content="What does an angry pepper do? It gets jalapeño face.">
<meta name="twitter:image" content="https://icanhazdadjoke.com/static/smile.png">
<meta name="twitter:url" content="https://icanhazdadjoke.com/j/ea2wkyscah" />
<link rel="canonical" href="https://icanhazdadjoke.com/j/ea2wkyscah">
<link rel="amphtml" href="https://icanhazdadjoke.com/j/ea2wkyscah/amp">
...
<p class="subtitle">What does an angry pepper do? It gets jalapeño face.</p>
</div>
<footer class="card-footer">
<a class="card-footer-item" href="/j/ea2wkyscah">
<span class="icon is-small">
...
<a class="card-footer-item" target="_blank" href="https://twitter.com/intent/tweet?url=https://icanhazdadjoke.com%2Fj%2Fea2wkyscah%2Famp&text=Check+out+this+%23dadjoke&via=icanhazdadjoke">
<span class="icon is-small">
...
<aside class="menu">
<ul class="menu-list">
<li><a href="/cdn-cgi/l/email-protection#fb888e8b8b94898fbb92989a95939a819f9a9f9194909ed5989496" target="_blank">Contact</a></li>
